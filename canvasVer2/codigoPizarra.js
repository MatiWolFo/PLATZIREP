...
boton_negro.addEventListener("click", trazo_negro);

function trazo_negro() { color_trazo = "black"; }
var boton_blanco = document.getElementById("boton_blanco");
boton_blanco.addEventListener("click", trazo_blanco);

function trazo_blanco() { color_trazo = "white"; }
var boton_rojo = document.getElementById("boton_rojo");
boton_rojo.addEventListener("click", trazo_rojo);

function trazo_rojo() { color_trazo = "red"; }
var boton_azul = document.getElementById("boton_azul");
boton_azul.addEventListener("click", trazo_azul);

function trazo_azul() { color_trazo = "blue"; }
var boton_verde = document.getElementById("boton_verde");
boton_verde.addEventListener("click", trazo_verde);

function trazo_verde() { color_trazo = "green"; }
var boton_amarillo = document.getElementById("boton_amarillo");
boton_amarillo.addEventListener("click", trazo_amarillo);

function trazo_amarillo() { color_trazo = "yellow"; }
var boton_cian = document.getElementById("boton_cian");
boton_cian.addEventListener("click", trazo_cian);

function trazo_cian() { color_trazo = "cyan"; }
var boton_magenta = document.getElementById("boton_magenta");
boton_magenta.addEventListener("click", trazo_magenta);

function trazo_magenta() { color_trazo = "magenta"; }
var boton_cafe = document.getElementById("boton_cafe");
boton_cafe.addEventListener("click", trazo_cafe);

function trazo_cafe() { color_trazo = "brown"; }
var boton_gris = document.getElementById("boton_gris");
boton_gris.addEventListener("click", trazo_gris);

function trazo_gris() { color_trazo = "gray"; }
var boton_naranja = document.getElementById("boton_naranja");
boton_naranja.addEventListener("click", trazo_naranja);

function trazo_naranja() { color_trazo = "orange"; }
var boton_teal = document.getElementById("boton_teal");
boton_teal.addEventListener("click", trazo_teal);

function trazo_teal() { color_trazo = "teal"; }
var boton_rosa = document.getElementById("boton_rosa");
boton_rosa.addEventListener("click", trazo_rosa);

function trazo_rosa() { color_trazo = "pink"; }
